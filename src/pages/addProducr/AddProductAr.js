...
export default function AddProductAr() {
    ...
    return (
        <div className="add-product">
            ...
            <h3 className="text-info my-3">إضافة منتج</h3>
            <form className="row g-3 needs-validation" noValidate>
            <div className="en col-6" dir="ltr">
            ...
            <div className="container ">
                <div className="text-center not-found m-5">
                    ...
                    <p className="lead my-3 fw-bold">هذه الصفحة غير متاحة لغير البائع</p>
                </div>
            </div>   
        }
            <FooterAr />
